...
class HwAdapter extends BaseAdapter {
    ...
    DateFormat df;
    List<AppointDetails> appointDetailsList;
    private ArrayList<String> items;
    public static List<String> day_string;
    public ArrayList<AppointDetails>  date_collection_arr;
    ...
    public HwAdapter(Activity context, GregorianCalendar monthCalendar,ArrayList<AppointDetails> date_collection_arr) {
   ...
   /* public void setEventView(View v,int pos,TextView txt){
     ...
     public void getPositionList(final String dateSelected, final Activity act){

         datacal.child(dateSelected).addValueEventListener(new ValueEventListener() {
             @Override
             public void onDataChange(DataSnapshot dataSnapshot) {
                 AppointDetails lecCal = dataSnapshot.getValue(AppointDetails.class);

                 if (lecCal != null) {
                     if (lecCal.getDate().equals(dateSelected)) {
                 ...
                 StudentAppoint adapter = new StudentAppoint(act, appointDetailsList);
