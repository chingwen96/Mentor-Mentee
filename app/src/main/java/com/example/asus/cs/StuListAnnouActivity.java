...
public class StuListAnnouActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewAnnounce.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent1 = new Intent(StuListAnnouActivity.this,CommentStuActivity.class);
                intent1.putExtra(ANN_KEY, user.getKey());
                intent1.putExtra(ANN_NAME, user.getAnnName());
                intent1.putExtra(ANN_ANNOUNCE, user.getAnnounce());
                //intent1.putExtra(MENTORS2_NAME,names);
                intent1.putExtra(MENTEE2_NAME,names1);
    ...
    protected  void onStart(){
        ...
        databaseAnnounce.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AnnounceList adapter = new AnnounceList(StuListAnnouActivity.this,announceList);
